...
<div class="flex flex-row h-full">
  <nav id="menu" class="bg-white dark:bg-gray-800 w-20 h-screen justify-between flex flex-col">
          ...
          <div class="mt-10">
              <ul>
                  <li class="my-12 text-center">
                      <a href="#" class="wski_tooltip" data-tooltip="Clienti">
                  ...
                  <li class="my-12 text-center">
                      <a href="#" class="wski_tooltip" data-tooltip="Timer">
                          <span class="h-6 w-6 text-gray-500 dark:text-gray-300 mx-auto hover:text-yellow-900 dark:hover:text-white transition-colors duration-200">
                              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 16 16">
                  ...
                  <li class="my-12 text-center">
                      <a href="#" class="wski_tooltip" data-tooltip="Storico">
                          <span class="h-6 w-6 text-gray-500 dark:text-gray-300 mx-auto hover:text-yellow-900 dark:hover:text-white transition-colors duration-200">
                              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 16 16">
                  ...
                  <li class="my-12 text-center">
                      <a href="#" class="wski_tooltip" data-tooltip="Servizi">
      ...
      <div class="mb-4">
          <a href="#" class="wski_tooltip more_left" data-tooltip="logout">
              <span>
